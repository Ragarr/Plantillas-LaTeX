% UC3M report template. English version of main.tex: same package, same
% layout; the only change is the babel line below. Demo of the title block
% with subject/degree/group/professor, sections and subsections, a list, a
% table, a figure, a formula and links.
%
...
% babel goes BEFORE uc3mdoc: the package loads hyperref internally, and
...
$\rho = \lambda / \mu$ the system utilisation.
...
whereas throughput levels off well before that limit.
