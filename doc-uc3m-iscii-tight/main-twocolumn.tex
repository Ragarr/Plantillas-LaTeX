...
% (con la fila de logos UC3M + ISCIII incluida) a ancho completo por encima
% de las dos columnas, igual que hace article.cls por defecto. Para floats
% a ancho completo (dos columnas) en documentos mas largos, usar los
% entornos estandar "figure*"/"table*" -- ver el aviso en
% uc3misciitight.sty sobre por que la figura de esta demo usa en cambio un
% "figure" normal (ancho de una columna).
%
...
escritura sobre las tablas afectadas~\cite{silberschatz2019}. La clave de
caché se construye a partir de la consulta parametrizada y sus
...
expiración de la entrada; el enfoque por notificación, el usado aquí~\cite{fitzpatrick2004}, evita
